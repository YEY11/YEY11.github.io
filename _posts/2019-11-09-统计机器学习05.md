...
算法  |  最小化目标函数  |  正则项  |  解
------  | ------  |  ------  |  ------
线性回归  |  $\\|\boldsymbol y-\boldsymbol{Xw}\\|_2^2$  | 无 | $(\boldsymbol{X'X})^{-1}\boldsymbol{X'y}$<br>（如果逆存在）
岭回归 | $\\|\boldsymbol y-\boldsymbol{Xw}\\|_2^2+\lambda\\|\boldsymbol w\\|_2^2$ | $L_2$ 范数<br>高斯先验<br><img src="https://tva1.sinaimg.cn/large/006y8mN6ly1g8efti6nklj30580583yf.jpg" width="40%" align="middle"> | $(\boldsymbol{X'X}+\lambda\boldsymbol I)^{-1}\boldsymbol{X'y}$
Lasso 回归 | $\\|\boldsymbol y-\boldsymbol{Xw}\\|_2^2+\lambda\\|\boldsymbol w\\|_1$  | $L_1$ 范数<br>拉普拉斯先验<br><img src="https://tva1.sinaimg.cn/large/006y8mN6ly1g8eg0pc0zyj3058056q2t.jpg" width="40%" align="middle"> | 无闭合解<BR>但解是稀疏的<br>适合高维数据
