...
岭回归 | $\parallel\boldsymbol y-\boldsymbol{Xw}\parallel_2^2+\lambda\parallel\boldsymbol w\parallel_2^2$ | $L_2$ 范数<br>高斯先验| $(\boldsymbol{X'X}+\lambda\boldsymbol I)^{-1}\boldsymbol{X'y}$
Lasso 回归 | $\parallel\boldsymbol y-\boldsymbol{Xw}\parallel_2^2+\lambda\parallel\boldsymbol w\parallel_1$  | $L_1$ 范数<br>拉普拉斯先验| 无闭合解<BR>但解是稀疏的<br>适合高维数据
