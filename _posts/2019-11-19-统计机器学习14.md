...
$\qquad \qquad \qquad$ **<span aligned="enter" style="font-size:10pt">一个简单线性模型</span>** **$\,y(x,\boldsymbol w)=w_0+w_1x\,$** **<span aligned="enter" style="font-size:10pt">使用顺序贝叶斯学习的例子</span>** 
