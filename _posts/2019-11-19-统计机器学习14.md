...
**<center><span style="color:red">MAP</span>  <span style="color:green">$\qquad \qquad$ approx.Bayes $\qquad \qquad$ exact Bayes</span></center>**

$\,$3. 寻找 $\boldsymbol w$ 的众数 $\qquad \qquad \qquad$ 3. 采用很多 $\boldsymbol w$ $\qquad \qquad$ 3. 使用所有的 $\boldsymbol w$  
$\,$4. 在测试集上进行预测 $\qquad$ 4. 在测试集上进行 **集成** 平均预测 $\quad$ 4. 在测试集上进行 **期望** 预测
