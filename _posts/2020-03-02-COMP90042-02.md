...
* 对于大多数 NLP 应用，我们的输入都是文档：
  * $“This\; movie\; is\; so\; great!!!\; U\; should\; definitely\; watch\; it\; in\; the\; theater!\; Best\; sci\text{-}fi$  
    $eva!”\to$ 😀

    在这个例子中，我们有一个情感预测任务：我们有一条用户评论，然后我们需要对其进行情感预测以便对电影进行评分。

  * $“Eu \;estive\; em \;Melbourne \;no\; ano\; passado.” \to “I\; was\; in\; Melbourne\; last\; year.”$
...
* 德语中可能存在一些非常长的复合词（compound），例如：  
  ...
  翻译过来的意思为：  
  $life\; insurance\; company \;employee$_（人寿保险公司员工）_
...
* 例如，我们可以将规则设定为：（m > 1）EMENT $\to$ null  
  * 然后，在此规则下，以单词 REPLACEMENT 为例：  
    <span style="color:green">R</span><span style="color:red">E</span><span style="color:green">PL</span><span style="color:red">A</span><span style="color:green">C</span><span style="color:red">E</span><span style="color:green">M</span><span style="color:red">E</span><span style="color:green">NT</span> = <span style="color:green">C</span><span style="color:red">V</span><span style="color:green">C</span><span style="color:red">V</span><span style="color:green">C</span><span style="color:red">V</span><span style="color:green">C</span><span style="color:red">V</span><span style="color:green">C</span> = <span style="color:green">C</span> (<span style="color:red">V</span><span style="color:green">C</span>)<sup><span style="color:">4</span></sup> $\to$ m = 4 > 1  
...
* **步骤 1:** 处理屈折形态变体（Inflectional Morphology Variants）  
  ...
  <img src="http://andy-blog.oss-cn-beijing.aliyuncs.com/blog/2020-03-03-WX20200304-000642%402x.png" width="80%">

* **步骤 2, 3, 4:** 处理派生形态变体（Derivational Morphology Variants）

  <img src="http://andy-blog.oss-cn-beijing.aliyuncs.com/blog/2020-03-03-WX20200304-000911%402x.png" width="80%">

* **步骤 5:** 整理

  <img src="http://andy-blog.oss-cn-beijing.aliyuncs.com/blog/2020-03-03-WX20200304-002405%402x.png" width="80%">
...
* **拼写变体规范化（Normalising spelling variations）**
  * $Normalize$ $\to$ $Normalise$（反之亦然）
  * $U\; r\; so\; coool!\;$ $\to$ $you\; are \;so\; cool\;$
* **缩写展开（Expanding abbreviations）**
  * $US,\;U.S.$ $\to$ $United\; States$
